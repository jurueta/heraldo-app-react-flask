    ...
    <div className="regis text-center">
      ...
      <form onSubmit={registerSubmit} className="text-center">
        <div className="form-group row">
          <label htmlFor="all-name" className="col-sm-3 col-form-label">
            Nombre completo:
          </label>
        ...
        <div className="form-group row">
          <label htmlFor="direction" className="col-sm-3 col-form-label">
            Dirección:
          </label>
          <div className="col-sm-8">
            ...
            <input
              type="text"
              onChange={(e) => {
                if (e.target.value.length <= 50) setDir(e.target.value);
              }}
              value={dir}
              className="form-control"
              name="direction"
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-8">
            ...
            <input
              type="text"
              onChange={(e) => validarPhone(e.target.value)}
              value={phone}
              className="form-control"
              name="phone"
              required
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-8">
            ...
            <input
              type="text"
              onChange={(e) => {
                if (e.target.value.length <= 50) setRegUser(e.target.value);
              }}
              value={regUser}
              className="form-control"
              name="user"
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-8">
            ...
            <input
              type="password"
              onChange={(e) => {
                if (e.target.value.length <= 50) setRegPass(e.target.value);
              }}
              value={regPass}
              className="form-control"
              name="pass"
        ...
        <div className="form-group row">
          <label htmlFor="mail" className="col-sm-3 col-form-label">
            Correo:
          </label>
          <div className="col-sm-8">
            ...
            <input
              type="email"
              onChange={(e) => {
                if (e.target.value.length <= 50) setMail(e.target.value);
              }}
              value={mail}
              className="form-control"
              name="mail"
